...
def _datacheck_peakdetect(x_axis, y_axis): #check for same length of X and Y. Arguments from data input
    if x_axis is None:
...
def _pad(fft_data, pad_len): #interpolate for fft. Where are the two arguments from?
    """
